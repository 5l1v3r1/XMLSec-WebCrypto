...
function findFirst(doc, input_xpath) {
  var nodes = xpath.select(input_xpath,doc)
  if (nodes.length==0) throw "could not find xpath " + input_xpath
  return nodes[0]
}
...
},{"./xpath.js":2}],2:[function(require,module,exports){
/*
 * xpath.js
 *
