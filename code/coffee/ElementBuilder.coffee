class window.ElementBuilder
  ...
  @buildWrappingElement:()->
    ...
    return xmlDoc
  ###
  buildSignedDataElement:(prefix) ->
    xmlNsAttrPrefix = prefix.replace(":","")
    docType =  document.implementation.createDocumentType("Object", "Object", "<!ENTITY Object 'Object'>");
    xmlDoc = document.implementation.createDocument("http://www.w3.org/2000/09/xmldsig#",prefix+"Object",docType)
    #xmlDoc.documentElement.setAttribute("xmlns:"+xmlNsAttrPrefix,"http://www.w3.org/2000/09/xmldsig#")
    return xmlDoc
  ###
